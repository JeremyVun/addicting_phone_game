...
- [x] phase 6 — tooling 2026-09-08; verification wave 2026-09-09 on emulator-5554: consent form, rewarded continue, interstitial, shop states, fresh-install first session, full loop, release build with clean logcat, six 9:16 store screenshots in `assets/store/screenshots/`; two defects fixed (continue double charge, stuck game over after a used continue); 390 tests
- [x] phase 7 — 63 probes (6 areas), 8 defects fixed (5 high: rewarded continue double-charge, negative coins, concurrent reroll, continue board-count corruption, commit-before-write), 3 rulings recorded; 387 tests
